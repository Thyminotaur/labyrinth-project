...
while True:
  ...
  cv.drawMarker(img, np.int32(center), (0, 255, 255), markerSize=40, thickness=4)
  cv.drawMarker(img, np.int32(center+np.array([offset_x, offset_y])), (0, 0, 255), markerSize=40, thickness=4)
